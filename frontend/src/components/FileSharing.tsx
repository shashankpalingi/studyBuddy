        ...
        try {
          ...
          snapshot.forEach((doc) => {
            ...
            loadedFiles.push({
              id: doc.id,
              ...data,
              // Handle backwards compatibility with existing publicId files
              storagePath: data.storagePath || data.publicId || "",
            } as SharedFile);
          });
  ...
  const handleDeleteFile = async (file: SharedFile) => {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "Failed to delete from Supabase, but file reference was removed:",
          supabaseError,
        );
      }
